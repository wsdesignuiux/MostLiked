package com.example.vaibhav.mostliked;
...
import model.MostLikedModel;

public class MostLikedActivity extends AppCompatActivity {
...
//        recycler code is here:
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(MostLikedActivity.this, 2);
        ...
        mostLikedAdapter = new MostLikedAdapter(MostLikedActivity.this,mostLikedModelArrayList);
